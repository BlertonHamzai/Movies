...
<head>
    ...
    <title>Edit Movie - {{ $movie->movie_name }}</title>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('movies.update', $movie->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea id="movie_desc" name="movie_desc" class="form-control" rows="4" required>{{ old('movie_desc', $movie->movie_desc) }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="movie_quality" name="movie_quality" class="form-control" 
                    value="{{ old('movie_quality', $movie->movie_quality) }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="movie_rating" name="movie_rating" class="form-control" min="0" max="10" step="0.1"
                    value="{{ old('movie_rating', $movie->movie_rating) }}">
                @error('movie_rating')
            ...
            <div class="mb-4">
                ...
                @if($movie->movie_image)
                    <small class="text-muted">Current: {{ $movie->movie_image }}</small>
                @endif
            </div>
